      ...
      <header className="sticky top-0 z-50 border-b border-line bg-paper/80 backdrop-blur-sm">
        <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <a href="/" className="flex items-center gap-2.5">
            <Image src="/logo.svg" alt="Researca" width={30} height={30} />
      ...
      <section className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center overflow-hidden px-6 py-24 text-center">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="mt-9 flex flex-col items-center gap-3">
            <a
              href="/auth"
              className="group inline-flex items-center gap-2 rounded-full bg-ink px-7 py-3.5 text-[15px] font-medium text-cream transition-transform duration-200 hover:scale-[1.02] hover:bg-ink-soft"
            >
          ...
          >
            ...
            <div className="p-5 sm:p-7">
                  ...
                  <tbody>
                    {DEMO_ROWS.map((row, i) => (
                      <tr key={i} className={`border-b border-line last:border-0 ${i % 2 === 1 ? "bg-paper/50" : ""}`}>
                        ...
                        <td className="px-4 py-4 align-top text-[13px] leading-relaxed text-[#3D3530]">{row.finding}</td>
              ...
              <div className="mt-5 rounded-xl border border-gold/30 bg-gold/[0.06] p-5">
                ...
                <p className="text-[14px] leading-relaxed text-[#3D3530]">
            ...
            <div className="flex flex-col rounded-2xl border border-line bg-cream p-8 sm:p-10">
              ...
              <ul className="mt-7 space-y-3">
                {["10 searches / month", "Synthesis mode", "Comparison matrix"].map((f) => (
                  <li key={f} className="flex items-center gap-2.5 text-[15px] text-[#3D3530]">
